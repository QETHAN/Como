...
Como.reg('editor/core.js', function(){
	...
	Editor.config = {
		...
		Style: {
			'default': [new Array('CODE'), new Array('BOLD', 'ITALIC', 'UNDERLINE','FONT', 'SIZE', 'COLOR', 'BGCOLOR'), new Array('LINK', 'UNLINK','LEFT', 'CENTER', 'RIGHT', 'INDENT', 'OUTDENT'), new Array('ICON', 'IMG','SPECIAL')],
